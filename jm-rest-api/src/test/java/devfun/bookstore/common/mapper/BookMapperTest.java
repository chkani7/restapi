...
public class BookMapperTest {
    ...
    public void testBookMpper() {
        ...
        assertEquals(newBook, selectedBook); // 신규 등록한 책과 조회한 책이  동일하면 테스트 통과  
        ...
        assertEquals("나잘난", selectedBook.getCreator()); // 수정한 정보가 동일하면 테스트 통과  

        bookMapper.deleteByPrimaryKey(10L);
        selectedBook = bookMapper.selectByPrimaryKey(10L);
        
        logger.info("d.selectedBook = {}", selectedBook);
        assertNull(selectedBook); // 삭제된 책이 없으면 테스트 통과  
    }
